...
OBJ = main.o gui.o terminal.o openai.o gemini.o commands.o update.o help.o menu.o utils.o tee_handler.o crypto.o session_manager.o resources.o policy_dao.o ratelimit.o
TARGET = aiterm
