...
OBJ = autoexec.o commands.o config.o crypto.o gemini.o gemini_cache.o gui.o help.o history_manager_gui.o \
      main.o menu.o noise_filter_manager_gui.o noisefilter.o openai.o policy_dao.o policy_manager_gui.o	\
